"""Fetch QQQ (Nasdaq-100) Top 50 stock prices from Yahoo Finance"""
...
# QQQ Top 50 tickers by market value (as of 2026-04-01)
QQQ_TOP50 = [
    # Rank 1-10
    'NVDA', 'AAPL', 'MSFT', 'AMZN', 'TSLA', 'META', 'WMT', 'GOOGL', 'GOOG', 'AVGO',
    # Rank 11-20
    'COST', 'NFLX', 'MU', 'PLTR', 'AMD', 'CSCO', 'AMAT', 'LRCX', 'TMUS', 'LIN',
    # Rank 21-30
    'INTC', 'PEP', 'KLAC', 'AMGN', 'TXN', 'GILD', 'ISRG', 'ADI', 'SHOP', 'HON',
    # Rank 31-40
    'QCOM', 'BKNG', 'PANW', 'APP', 'INTU', 'ASML', 'VRTX', 'CMCSA', 'SBUX', 'CEG',
    # Rank 41-50
    'ADBE', 'CRWD', 'WDC', 'MELI', 'MAR', 'MRVL', 'STX', 'ADP', 'REGN', 'ORLY'
]
...
print(f"Fetching QQQ Top 50 prices from {start_date.strftime('%Y-%m-%d')} to {end_date.strftime('%Y-%m-%d')}")
print(f"Total tickers: {len(QQQ_TOP50)}")
print()
...
if all_prices:
    ...
    # Save to CSV
    output_file = OUTPUT_DIR / 'QQQ_top50_prices.csv'
    ...
    ticker_file = OUTPUT_DIR / 'QQQ_top50_tickers.txt'
